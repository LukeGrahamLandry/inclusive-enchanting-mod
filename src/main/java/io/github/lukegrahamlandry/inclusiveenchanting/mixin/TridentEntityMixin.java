...
public abstract class TridentEntityMixin {
    ...
    @Redirect(method = "onEntityHit", at = @At(value = "INVOKE", target = "Lnet/minecraft/entity/projectile/TridentEntity;setMotion(Lnet/minecraft/util/math/vector/Vector3d;)V"))
    private void handlePiercing(TridentEntity instance, Vector3d vector3d) {
        ...
        if (self.getPierceLevel() <= 0){
            ...
            self.setMotion(self.getMotion().mul(-0.01D, -0.1D, -0.01D));
        } else {
    ...
    @Redirect(method = "onEntityHit", at = @At(value = "FIELD", target = "Lnet/minecraft/entity/projectile/TridentEntity;dealtDamage:Z", opcode=181))
